...
public:
  ...
  NodeData()
  : Node("nodeRawdata_surface"), count_(0)
  {
    ...
    publisher_raw_sensors_packet =  this->create_publisher<subsonus_pkg::msg::SubsonusRawSensorsPacket>("subsonus/raw_sensors_packet_surface", 1000);
    ...
    FD_ZERO(&readfds);
		...
		if(FD_ISSET(tcp_socket, &readfds))
		{
          ...
          // printf("test %u\n",an_packet->id);
              ...
              A << 7.673155245089292587e-01, 1.207864543966562787e-01, 1.366053089858131619e-01,
              1.207864543966562787e-01, 1.071568508802559494e+00, 3.346978073025512479e-02,
              1.366053089858131619e-01, 3.346978073025511785e-02, 1.262628593230086249e+00;

              Eigen::VectorXd b(3);
              b << 1.185240589581268011e+02,
              -2.545633838648003007e+02,
              -1.719887252029732281e+03;
